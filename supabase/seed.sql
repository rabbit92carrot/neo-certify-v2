...
-- Helper: 코드 생성 함수 (시드 전용, 결정적)
CREATE OR REPLACE FUNCTION _seed_code(prefix TEXT, idx INT) RETURNS TEXT AS $$
  SELECT prefix || '-' || lpad(idx::text, 4, '0');
$$ LANGUAGE sql;

-- ===== 코 임플란트 S - LOT 001 (15개) =====
-- 5개: 제조사 재고
INSERT INTO virtual_codes (id, code, lot_id, status, owner_org_id) VALUES
  ('f0000000-0000-0000-0001-000000000001', _seed_code('MT-NIS1', 1),  'e0000000-0000-0000-0000-000000000001', 'IN_STOCK', 'b0000000-0000-0000-0000-000000000002'),
  ('f0000000-0000-0000-0001-000000000002', _seed_code('MT-NIS1', 2),  'e0000000-0000-0000-0000-000000000001', 'IN_STOCK', 'b0000000-0000-0000-0000-000000000002'),
  ('f0000000-0000-0000-0001-000000000003', _seed_code('MT-NIS1', 3),  'e0000000-0000-0000-0000-000000000001', 'IN_STOCK', 'b0000000-0000-0000-0000-000000000002'),
  ('f0000000-0000-0000-0001-000000000004', _seed_code('MT-NIS1', 4),  'e0000000-0000-0000-0000-000000000001', 'IN_STOCK', 'b0000000-0000-0000-0000-000000000002'),
  ('f0000000-0000-0000-0001-000000000005', _seed_code('MT-NIS1', 5),  'e0000000-0000-0000-0000-000000000001', 'IN_STOCK', 'b0000000-0000-0000-0000-000000000002');
-- 5개: 유통사 재고
INSERT INTO virtual_codes (id, code, lot_id, status, owner_org_id) VALUES
  ('f0000000-0000-0000-0001-000000000006', _seed_code('MT-NIS1', 6),  'e0000000-0000-0000-0000-000000000001', 'IN_STOCK', 'b0000000-0000-0000-0000-000000000003'),
  ('f0000000-0000-0000-0001-000000000007', _seed_code('MT-NIS1', 7),  'e0000000-0000-0000-0000-000000000001', 'IN_STOCK', 'b0000000-0000-0000-0000-000000000003'),
  ('f0000000-0000-0000-0001-000000000008', _seed_code('MT-NIS1', 8),  'e0000000-0000-0000-0000-000000000001', 'IN_STOCK', 'b0000000-0000-0000-0000-000000000003'),
  ('f0000000-0000-0000-0001-000000000009', _seed_code('MT-NIS1', 9),  'e0000000-0000-0000-0000-000000000001', 'IN_STOCK', 'b0000000-0000-0000-0000-000000000003'),
  ('f0000000-0000-0000-0001-000000000010', _seed_code('MT-NIS1', 10), 'e0000000-0000-0000-0000-000000000001', 'IN_STOCK', 'b0000000-0000-0000-0000-000000000003');
-- 3개: 병원1 재고
INSERT INTO virtual_codes (id, code, lot_id, status, owner_org_id) VALUES
  ('f0000000-0000-0000-0001-000000000011', _seed_code('MT-NIS1', 11), 'e0000000-0000-0000-0000-000000000001', 'IN_STOCK', 'b0000000-0000-0000-0000-000000000004'),
  ('f0000000-0000-0000-0001-000000000012', _seed_code('MT-NIS1', 12), 'e0000000-0000-0000-0000-000000000001', 'IN_STOCK', 'b0000000-0000-0000-0000-000000000004'),
  ('f0000000-0000-0000-0001-000000000013', _seed_code('MT-NIS1', 13), 'e0000000-0000-0000-0000-000000000001', 'IN_STOCK', 'b0000000-0000-0000-0000-000000000004');
...
SELECT ('f0000000-0000-0000-0003-' || lpad(i::text, 12, '0'))::uuid,
       _seed_code('MT-NIM1', i), 'e0000000-0000-0000-0000-000000000003', 'IN_STOCK',
       CASE
...
SELECT ('f0000000-0000-0000-0004-' || lpad(i::text, 12, '0'))::uuid,
       _seed_code('MT-NIM2', i), 'e0000000-0000-0000-0000-000000000004', 'IN_STOCK',
       'b0000000-0000-0000-0000-000000000002'
...
SELECT ('f0000000-0000-0000-0005-' || lpad(i::text, 12, '0'))::uuid,
       _seed_code('MT-NIL1', i), 'e0000000-0000-0000-0000-000000000005', 'IN_STOCK',
...
SELECT ('f0000000-0000-0000-0006-' || lpad(i::text, 12, '0'))::uuid,
       _seed_code('MT-NIL2', i), 'e0000000-0000-0000-0000-000000000006', 'IN_STOCK',
       'b0000000-0000-0000-0000-000000000002'
FROM generate_series(1, 10) AS i;
...
SELECT ('f0000000-0000-0000-0007-' || lpad(i::text, 12, '0'))::uuid,
       _seed_code('MT-CIG1', i), 'e0000000-0000-0000-0000-000000000007', 'IN_STOCK',
...
SELECT ('f0000000-0000-0000-0008-' || lpad(i::text, 12, '0'))::uuid,
       _seed_code('MT-CIG2', i), 'e0000000-0000-0000-0000-000000000008', 'IN_STOCK',
       'b0000000-0000-0000-0000-000000000002'
FROM generate_series(1, 10) AS i;
...
SELECT ('f0000000-0000-0000-0009-' || lpad(i::text, 12, '0'))::uuid,
       _seed_code('MT-CIG3', i), 'e0000000-0000-0000-0000-000000000009', 'IN_STOCK',
       'b0000000-0000-0000-0000-000000000002'
...
SELECT ('f0000000-0000-0000-0010-' || lpad(i::text, 12, '0'))::uuid,
       _seed_code('MT-FH05A', i), 'e0000000-0000-0000-0000-000000000010', 'IN_STOCK',
...
SELECT ('f0000000-0000-0000-0011-' || lpad(i::text, 12, '0'))::uuid,
       _seed_code('MT-FH05B', i), 'e0000000-0000-0000-0000-000000000011', 'IN_STOCK',
       'b0000000-0000-0000-0000-000000000002'
FROM generate_series(1, 15) AS i;
...
SELECT ('f0000000-0000-0000-0012-' || lpad(i::text, 12, '0'))::uuid,
       _seed_code('MT-FH10A', i), 'e0000000-0000-0000-0000-000000000012', 'IN_STOCK',
...
SELECT ('f0000000-0000-0000-0013-' || lpad(i::text, 12, '0'))::uuid,
       _seed_code('MT-FH10B', i), 'e0000000-0000-0000-0000-000000000013', 'IN_STOCK',
       'b0000000-0000-0000-0000-000000000002'
FROM generate_series(1, 15) AS i;
...
SELECT ('f0000000-0000-0000-0014-' || lpad(i::text, 12, '0'))::uuid,
       _seed_code('MT-FH20A', i), 'e0000000-0000-0000-0000-000000000014', 'IN_STOCK',
       CASE WHEN i <= 5 THEN 'b0000000-0000-0000-0000-000000000002'::uuid
            WHEN i <= 8 THEN 'b0000000-0000-0000-0000-000000000003'::uuid
            ELSE 'b0000000-0000-0000-0000-000000000004'::uuid END
FROM generate_series(1, 10) AS i;
...
SELECT ('f0000000-0000-0000-0015-' || lpad(i::text, 12, '0'))::uuid,
       _seed_code('MT-FH20B', i), 'e0000000-0000-0000-0000-000000000015', 'IN_STOCK',
       'b0000000-0000-0000-0000-000000000002'
FROM generate_series(1, 10) AS i;
...
-- ============================================================
DROP FUNCTION IF EXISTS _seed_code(TEXT, INT);
